<template>
	<header ref="header">
		<div class="view">
			<img ref="imgbg1" src="https://www.bzyl.site/static/bg4.jpg" style="display: none;">
			<div class="bg1" style="background-image: url('https://www.bzyl.site/static/bg1.jpg');"></div>
